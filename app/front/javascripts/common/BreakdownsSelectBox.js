    ...
    return (
      <span className='breakdowns-select-box-component'>
        <div className='input-group mb-1'>
          <select className='form-control' disabled={this.props.isDisabled} id='selectable-breakdowns' onChange={this.handleSelectBreakdown} value={this.props.selectedBreakdownId || ''}>
