...
class EditRecordModal extends Component<Props> {
              ...
              <div className='modal-body'>
                {this.props.editRecordStore.errors.length > 0 && (
                  <div className='validation-errors-field'>
                    <ValidationErrorMessages errors={this.props.editRecordStore.errors} />
                  </div>
                )}
                <RecordForm
                  currency={this.props.profileStore.currency}
...
export default connect(mapState, mapDispatch)(withRouter(EditRecordModal))
