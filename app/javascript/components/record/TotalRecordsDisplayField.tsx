...
class TotalRecordsDisplayField extends Component<Props> {
  render(): JSX.Element {
    const { t } = this.props

    return (
      <div className='total-records-display-field-component'>
...
export default withTranslation()(TotalRecordsDisplayField)
