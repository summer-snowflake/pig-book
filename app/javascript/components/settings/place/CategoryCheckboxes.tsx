...
class CategoryCheckboxes extends Component<Props, State> {
            ...
            {this.props.categories.map((category) => (
              <span key={category.id}>
                ...
                <label className='checkbox-label' htmlFor={'category-' + category.id}>
                  ...
                  <CategoryName balanceOfPayments={category.balance_of_payments} name={category.name} />
                </label>
              </span>
            ))}
          </div>
...
export default connect(mapState, mapDispatch)(CategoryCheckboxes)
