...
import { newRecord } from 'actions/recordStoreActions'
...
import TotalRecordsDisplayField from 'components/record/TotalRecordsDisplayField'
...
class RecordsListByDay extends Component<Props> {
...
export default connect(mapState, mapDispatch)(withTranslation()(RecordsListByDay))
