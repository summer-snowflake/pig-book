...
class NewRecordField extends Component<Props> {
      ...
      <div className='new-record-form-component'>
        {this.props.newRecordStore.errors.length > 0 && (
          <div className='validation-errors-field'>
            <ValidationErrorMessages errors={this.props.newRecordStore.errors} />
          </div>
        )}
        <RecordForm
          currency={this.props.profileStore.currency}
...
export default connect(mapState, mapDispatch)(withRouter(NewRecordField))
