  ...
  context 'ログインしていた場合' do
    ...
    context '登録されている集計対象のデータがある場合' do
      ...
      it '200とデータが返ってくること' do
        ...
        expect(user.monthly_balance_tables.pluck(:year, :month))
          .to eq [[2018, 2], [2018, 4], [2018, 11], [2017, 10],
                  [2017, 1], [2017, 2], [2017, 3], [2017, 4], [2017, 5],
                  [2017, 6], [2017, 7], [2017, 8], [2017, 9], [2017, 11],
                  [2017, 12], [2018, 1], [2018, 3], [2018, 5], [2018, 6],
                  [2018, 7], [2018, 8], [2018, 9], [2018, 10], [2018, 12]]
      end
    end
