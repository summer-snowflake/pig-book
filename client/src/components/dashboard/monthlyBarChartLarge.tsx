...
class MonthlyBarChartLarge extends Component<Props> {
  ...
  render(): JSX.Element {
    ...
    return (
      <div className='monthly-bar-chart-large-component'>
        {this.props.monthlyTotal.length > 0 && (
          ...
          >
            ...
            <XAxis dataKey='month' unit={t('label.month')} />
            <YAxis
...
export default withTranslation()(MonthlyBarChartLarge)
